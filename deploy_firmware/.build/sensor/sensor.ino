...
// ===========================================
const char* WIFI_SSID      = "Anh Hang Xom";
const char* WIFI_PASSWORD   = "vannhucu";

const char* MQTT_BROKER    = "4061ab01ecb84322bec7b3914b4fc686.s1.eu.hivemq.cloud";
const int   MQTT_PORT      = 8883;
const char* MQTT_CLIENT_ID  = "air_quality_sensor_001";
const char* MQTT_USERNAME   = "ToQuyThanh";
const char* MQTT_PASSWORD   = "Tqt@123456";
const char* LOCATION        = "Cau Dien";

const unsigned long MEASUREMENT_INTERVAL    = 30000;
...
// MQTT Topics
// ===========================================
const char* MQTT_TOPIC_TEMPERATURE = "sensors/air_quality_sensor_001/temperature";
const char* MQTT_TOPIC_HUMIDITY    = "sensors/air_quality_sensor_001/humidity";
const char* MQTT_TOPIC_HEAT_INDEX  = "sensors/air_quality_sensor_001/heatindex";
const char* MQTT_TOPIC_PM1         = "sensors/air_quality_sensor_001/pm1";
const char* MQTT_TOPIC_PM25        = "sensors/air_quality_sensor_001/pm25";
const char* MQTT_TOPIC_PM10        = "sensors/air_quality_sensor_001/pm10";
const char* MQTT_TOPIC_STATUS      = "sensors/air_quality_sensor_001/status";
